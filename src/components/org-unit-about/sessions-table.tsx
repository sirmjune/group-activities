                    ...
                    <form onSubmit={handleFormSubmit} className="form">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Introducing the program and defining goals">Introducing the program and defining goals</option>
                                <option value="Building a positive relationship thru">Building a positive relationship thru</option>
                                <option value="Talking about emotions">Talking about emotions</option>
                                <option value="Managing anger & solving problems">Managing anger & solving problems</option>
                                <option value="Problem solving-putting out the fire spending time together">Problem solving-putting out the fire spending time together</option>
                                <option value="Problem solving-putting out the fire spending time">Problem solving-putting out the fire spending time</option>
                                <option value="Motivation to save and making a budget">Motivation to save and making a budget</option>
                                <option value="Dealing with problems without Conflict-I">Dealing with problems without Conflict-I</option>
                                <option value="Dealing with problems without conflict-II">Dealing with problems without conflict-II</option>
                                <option value=" Establishing family rules and routines"> Establishing family rules and routines</option>
                                <option value="Understanding the ways to save and the risk to borrow">Understanding the ways to save and the risk to borrow</option>
                                ...
                                <option value="Leadership and Elections of the Management committee">Leadership and Elections of the Management committee</option>
                                <option value="Leadership and Elections of the Management committee">Leadership and Elections of the Management committee</option>
                                <option value="Introduction to written record keeping">Introduction to written record keeping</option>
                                <option value="Meeting procedures/ meeting steps">Meeting procedures/ meeting steps</option>
                                ...
                                <option value="Financial Literacy and Bank Linkage">Financial Literacy and Bank Linkage</option>
                                <option value="Selection Planning and Management of IGAs">Selection Planning and Management of IGAs</option>
                                ...
                                <option value="Rating of Mature groups for Bank linkage">Rating of Mature groups for Bank linkage</option>
                                <option value="Sensitization on linkage banking">Sensitization on linkage banking</option>
                                <option value="Account opening process">Account opening process</option>
                                <option value="Monitoring the performance of Linked groups">Monitoring the performance of Linked groups</option>
                                ...
                                <option value="Estimation of start-up and working costs"> Estimation of start-up and working costs</option>
                                <option value="Estimating sales and Income">Estimating sales and Income</option>
                                <option value="Weekly expenses and Weekly income">Weekly expenses and Weekly income</option>
                                ...
                                <option value="Resisting negative peer pressure">Resisting negative peer pressure</option>
                                ...
                                <option value="HIV & School Related Gender Based Violence (SRGBV) risk and protection">HIV & School Related Gender Based Violence (SRGBV) risk and protection</option>
                                <option value="HIV & School Related GBV risk and protection">HIV & School Related GBV risk and protection</option>
                                <option value="Positive bystander response to violence"> Positive bystander response to violence</option>
                            </select>
